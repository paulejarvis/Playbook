...
Employer Identification Number (EIN)
    Licenses / Permits (according to category)
    ...
    Alcoholic beverages - manufacturers, wholesalers, importers and retailers of alcohol beverages must register, pay special taxes and maintain certain records with the Alcohol and Tobacco Tax and Trade Bureau(ATTB).
...
Compliance regulations to build out
- GDPR
- SOC2
- GDPR
- state-specific regulations

Some laws apply to everyone
* child labor laws
* OSHA - employee safety
* Immigration reform and control act (form I-9)
* independent contractor rules from the IRS
* Military service leave
* Display of appropriate noties and posters
* Privacy
